...
import 'package:task_manager_new/data/models/task_count_by_status_wrapper_model.dart';
import 'package:task_manager_new/data/models/task_list_wrapper_model.dart';
...
import 'package:task_manager_new/ui/screens/add_new_task_screen.dart';
...
class _NewTaskScreenState extends State<NewTaskScreen> {
  ...
  Future<void> _getTaskCountByStatus() async{
    ...
    if(response.isSuccess){
      ...
      if(mounted){
        showSnackBarMessage(context, response.errorMessage ?? 'Get task count by status failed! Try again.');
      }
    }
